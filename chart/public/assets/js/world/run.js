! function(t) {
    ...
    function _clearChartEvents() {
        _events.forEach(function(t) {
            if (myChart) myChart.off(t);
            else
                for (var e = 0; e < myCharts.length; ++e) myCharts[e].off(t)
        }), _events.length = 0
    }
    ...
    function renderPartialCanvas(t, e, n, i) {
        var o = document.createElement("canvas");
        o.width = 2 * e, o.height = 2 * n;
        var a = document.createElement("canvas");
        a.width = e, a.height = n;
        var r = a.getContext("2d"),
            s = echarts.init(o),
            h = myChart ? myChart.getOption() : myCharts[t].getOption(),
            _ = myChart ? myChart.getModel() : myCharts[t].getModel(),
            p = _.getComponent("title"),
            l = [],
            c = ["markLine", "markPoint", "markArea", "series", "xAxis", "yAxis", "xAxis3D", "yAxis3D", "zAxis3D", "angleAxis", "radiusAxis", "parallelAxis", "axisPointer"];
        for (var u in h) c.indexOf(u) < 0 && _.getComponent(u) && ("grid" === u && _.getComponent("xAxis") && _.getComponent("yAxis") || "grid" !== u) && l.push({
            type: "component",
            value: u
        });
        var d = {};
        _.eachComponent("series", function(t) {
            var e = t.subType;
            d[e] || (d[e] = !0, l.push({
                type: "chart",
                value: e
        ...
        var g = {};
        if (_.eachComponent("series", function(t) {
                ["markPoint", "markLine", "markArea"].forEach(function(e) {
                    t.get(e, !0) && !g[e] && (l.push({
                        type: "component",
                        value: e
                    }), g[e] = !0)
                })
            }), h.timeline && h.timeline.length) {
            var m = h.timeline[0];
            m.currentIndex = 0, h.timeline = null;
            var w = {
                timeline: m,
                options: []
            };
            h.animation = !1;
            for (var f = 0; f < m.data.length; f++) w.options.push(h);
            h = w
        }
        h.animation = !1, h.series && h.series.forEach(function(t) {
            "graph" === t.type && "force" === t.layout && (t.force = t.force || {}, t.force.layoutAnimation = !1), t.progressive = 0, t.progressiveThreshold = 1 / 0
        }), s.setOption(h, !0), setTimeout(function() {
            r.drawImage(o, 0, 0, a.width, a.height), i({
                title: p && p.get("text") || "",
                subtitle: p && p.get("subtext") || "",
                tags: l,
                canvas: a
            })
        }, 100)
    }
    var _originWhiteList = ["http://gallery.echartsjs.com", "http://127.0.0.1:3000", "http://echarts.duapp.com", "http://159.89.233.136/volumetracker.php", "http://159.89.233.136"],
        myChart = null,
        myCharts = [];
    $(document).ready(function() {
        ...
        if (window.addEventListener ? window.addEventListener("message", t, !1) : window.attachEvent("onmessage", t), window.__currentLayout__ && window.__layoutCustomized__) var e = window.__layoutWidth__.length * window.__layoutHeight__.length;
        else var e = 0;
        ...
        __actions__ = {
            ...
            create: function(t) {
                if (t) {
                    ...
                    myCharts = [];
                    var n = t;
                    if (window.__currentLayout__ && window.__layoutCustomized__) n = window.__layoutWidth__.length * window.__layoutHeight__.length;
                    else if (window.__layoutWidth__ = [], window.__layoutHeight__ = [], "1xN" === window.__currentLayout__) {
                    ...
                    for (var a = 0, r = 0; r < window.__layoutHeight__.length; ++r)
                        for (var s = 0; s < window.__layoutWidth__.length && !(a >= t); ++s) {
            ...
            run: function(data) {
                ...
                try {
                    ...
                    option = myChart.getModel() ? null : {
                        series: []
                    }, __err__ = e.toString()
                }
                if (option) myChart.setOption(option, !0);
                else if (options) {
            ...
            prepareChartDetail: function(t) {
                ...
                function n(t, e) {
                    var _ = c[t],
                        l = (_.right - _.left) / g * i.width,
                        u = (_.bottom - _.top) / m * i.height,
                        d = {
                            left: h + (_.left - h) / g * i.width,
                            top: p + (_.top - p) / m * i.height
                        };
                    renderPartialCanvas(t, l, u, function(i) {
                        o.drawImage(i.canvas, d.left, d.top), a = a || i.title, r = r || i.subtitle, s = s.concat(i.tags), t + 1 < myCharts.length ? n(t + 1, e) : e()
                    })
                }
                var i = document.createElement("canvas");
                i.width = 400, i.height = 300;
                for (var o = i.getContext("2d"), a = "", r = "", s = [], h = Number.MAX_VALUE, _ = 0, p = Number.MAX_VALUE, l = 0, c = [], u = 0; u < myCharts.length; ++u) {
                    var d = myCharts[u].getDom().getBoundingClientRect();
                    c.push(d), h = Math.min(h, d.left), _ = Math.max(_, d.right), p = Math.min(p, d.top), l = Math.max(l, d.bottom)
                }
                var g = _ - h,
                    m = l - p;
                try {
